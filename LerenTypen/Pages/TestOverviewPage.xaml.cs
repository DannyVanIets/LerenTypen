...
namespace LerenTypen
{
    ...
    public partial class TestOverviewPage : Page
    {
        ...
        private void GetTrendingTests()
        {
            ...
            {
                TrendingTableContent.Add(new TestTable(counter, test.Name, test.TimesMade, test.WordHighscore, test.WordCount, test.Difficulty, test.AuthorUsername,test.AverageScore, 0, test.ID ));
                counter++;
            }
        }
